"""T-17 — run the live verifier over every gate-reachable claim and record it (D77).
...
named in the recording (D5). A rejection is a finding, not an answer (D77):
...
def measure() -> int:
    ...
    if rejections:
        # D77: a rejection is a finding. The recording exists so the claim can
