...
- **The pass that would have retired that caveat is deferred, not done** (D79, D81). T-78 is the owner's adjudication of every label and manifest; it sits in the board's *Deferred — under review* section, so every figure here is measured against proposals rather than against adjudicated ground truth.
