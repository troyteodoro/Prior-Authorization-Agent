...
| `docs/decisions.md` | D1–D82, kill criteria, open questions. Append-only. |
...
**53 of 65 tasks closed, 9 open, 3 deferred under review. All 9 gates green**
...
Open, in order: **T-32 → T-22 → T-28 → T-23**, with T-27, T-42, T-70,
